...
@Composable
fun EditUser(userId: Int, navController: NavController, viewModel: MainViewModel) {
...
@Composable
fun DefaultPreviewEditUser() {
    val navController = rememberNavController()
    val userId = 1
    val viewModel = viewModel<MainViewModel>()
    EditUser(userId = userId, navController = navController, viewModel = viewModel)
}